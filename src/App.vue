...
<template>
  <main class="page-wrap">
    <section class="hero-shell">
      ...
      <div class="relative">
        <p class="mb-3 text-sm font-bold tracking-[0.18em] text-[#9a5c1f] uppercase">
          Vite + Vue 3 + TypeScript + Element Plus
        </p>
        <h1 class="m-0 text-[clamp(36px,5vw,62px)] leading-[1.05] tracking-[-0.04em] text-[#24170f]">
          一个已经带好工程规范的前端起点
        </h1>
        <p class="mt-5 max-w-[720px] text-lg leading-[1.75] text-[#24170fc2]">
    ...
    <el-alert
      class="mt-[18px] rounded-[20px] border border-emerald-200/70 shadow-sm"
    ...
    <section class="mt-[18px] grid gap-[18px] md:grid-cols-2">
    ...
    <section class="mt-[18px] grid gap-[18px] lg:grid-cols-[1.1fr_1fr]">
